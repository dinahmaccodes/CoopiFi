    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Stake your tokens in liquidity pools to earn rewards and support the cooperative ecosystem.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-gradient-card border-border">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-card-foreground mt-1">{pools.length}</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-card border-border">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-card-foreground mt-1">$2.45M</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-card border-border">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-card-foreground mt-1">9.5%</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-card border-border">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-card-foreground mt-1">100%</div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="space-y-6">
        {pools.map((pool, index) => (
          <Card key={index} className="bg-gradient-card border-border hover:border-coopifi-primary/50 transition-colors">
            <CardHeader>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl text-card-foreground flex items-center gap-2">
                      ...
                      <Badge 
                        variant="outline" 
                        className={`border-${getRiskColor(pool.riskLevel)} text-${getRiskColor(pool.riskLevel)}`}
                      >
                        {pool.risk}
                      </Badge>
                    </CardTitle>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <p className="text-lg font-semibold text-card-foreground">{pool.balance}</p>
                </div>
                
                <div>
                  <p className="text-sm text-muted-foreground">Annual Yield</p>
                  <p className="text-lg font-semibold text-success">{pool.apy}</p>
                </div>
                
                <div>
                  <p className="text-sm text-muted-foreground">Token Symbol</p>
                  <p className="text-lg font-semibold text-card-foreground">{pool.symbol}</p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-sm font-medium text-card-foreground">{pool.utilization}%</span>
                  </div>
                </div>
              </div>
            </CardContent>
